...
{: caption="表 1. 每一個 `ibmliberty` 映像檔中包含的特性" caption-side="top"}
...
|正式作業|`ibmliberty` 映像檔的免費使用，侷限於所有執行該映像檔的容器實例中，**最多 2 GB Java 資料堆空間**。例如，您可以免費有 2 個 1 GB 或 4 個 512 MB 資料堆的 Liberty 實例。|
