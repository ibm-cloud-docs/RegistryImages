...
|BACKUP_TYPE|`full`. Padrão. É feito backup de todos os arquivos toda vez.<br/> `incremental`. O backup é feito somente para arquivos novos ou mudados. Se você escolher `incremental`, deverá
