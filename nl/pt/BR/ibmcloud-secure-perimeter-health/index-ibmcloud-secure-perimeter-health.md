...
Para obter mais informações sobre como obter acesso ao seu cluster após a implementação, consulte [{{site.data.keyword.containerlong_notm}}](/docs/containers?topic=containers-getting-started#getting-started).
