...
En lugar de la imagen `ibm-node-strong-pm`, [empiece a trabajar con el servicio {{site.data.keyword.apiconnect_short}}](/docs/services/apiconnect/index.html#index).
