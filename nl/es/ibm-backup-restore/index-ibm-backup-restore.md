...
|SCHEDULE_INFO|`hourly`. Cree una copia de seguridad por hora. <br/>`daily`. Predeterminado. Cree una copia de seguridad diaria. <br/>`weekly`. Cree una copia de seguridad semanal. Debe incluir esta variable si planifica una actualización periódica.|
