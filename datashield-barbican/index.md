...
This container image provides protection for data that is in use by running Barbican in the Data Shield environment. For more information about the service and what it means to protect your data in use, you can learn [about the service](/docs/services/data-shield?topic=data-shield-about#about).
{: shortdesc}
